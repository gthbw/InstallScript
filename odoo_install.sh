...
sudo -H pip3 install -r https://github.com/gthbw/odoo/raw/${OE_VERSION}/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/gthbw/odoo $OE_HOME_EXT/
